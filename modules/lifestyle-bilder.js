...
const PROMPTS = {
  pawvero: [
    'Professional lifestyle product photography. Show the exact product from the reference image in real use with a happy dog, bright modern German home interior, natural window light, editorial pet-brand photography style, photorealistic, preserve exact product design, shape and color from the reference image, no added text, no logo changes.',
    'Professional lifestyle product photography. Show the exact product from the reference image in real use with a happy dog in a sunny backyard or park setting, natural outdoor light, editorial pet-brand photography style, photorealistic, preserve exact product design, shape and color from the reference image, no added text, no logo changes.'
  ],
  wabipaper: [
